...
#key column to split results by.
#Can allow this to vary, but difficult to set a default value that would be sensible for this column so forcing it to be picked up front.
